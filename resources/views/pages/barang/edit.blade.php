                        ...
                        <form class="forms-sample" action="{{ route('barang.update',$data->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="merk" value="{{ old('merk',$data->merk) }}" class="form-control @error('merk') is-invalid @enderror" id="exampleInputUsername1" placeholder="Masukkan Merk">
                                      @error('merk')
                                      <small class="text-danger" style="font-size: 12px">
                                          {{ $message }}.
                                      </small>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="bahan" value="{{ old('bahan',$data->bahan) }}" class="form-control @error('bahan') is-invalid @enderror" id="exampleInputUsername1" placeholder="Masukkan bahan">
                                          @error('bahan')
                                          <small class="text-danger" style="font-size: 12px">
                                              {{ $message }}.
                                          </small>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ukuran" value="{{ old('ukuran',$data->ukuran) }}" class="form-control @error('ukuran') is-invalid @enderror" id="exampleInputUsername1" placeholder="Masukkan Ukuran">
                                          @error('ukuran')
                                          <small class="text-danger" style="font-size: 12px">
                                              {{ $message }}.
                                          </small>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" data-provide="tahun" name="tahun" value="{{ old('tahun',$data->tahun) }}" class="form-control tahun @error('tahun') is-invalid @enderror" id="exampleInputUsername1" placeholder="Masukkan Tahun">
                                          @error('tahun')
                                          <small class="text-danger" style="font-size: 12px">
                                              {{ $message }}.
                                          </small>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="asal_barang" value="{{ old('asal_barang',$data->asal_barang) }}" class="form-control @error('asal_barang') is-invalid @enderror" id="exampleInputUsername1" placeholder="Masukkan Asal Barang">
                                          @error('asal_barang')
                                          <small class="text-danger" style="font-size: 12px">
                                              {{ $message }}.
                                          </small>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kondisi_barang" value="{{ old('kondisi_barang',$data->kondisi_barang) }}" class="form-control @error('kondisi_barang') is-invalid @enderror" id="exampleInputUsername1" placeholder="Masukkan Kondisi Barang">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="jumlah_barang" value="{{ old('jumlah_barang',$data->jumlah_barang) }}" class="form-control @error('jumlah_barang') is-invalid @enderror" id="exampleInputUsername1" placeholder="Masukkan Harga Barang">
                                          @error('jumlah_barang')
                                          <small class="text-danger" style="font-size: 12px">
                                              {{ $message }}.
                                          </small>
